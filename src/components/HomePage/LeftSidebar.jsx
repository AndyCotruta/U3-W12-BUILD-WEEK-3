  ...
  return (
    <>
      <Col className="left-side-col">
        <div className="left-profile-mini">
          ...
          <div className="profile-text-area-mini">
            <div className="profile-text-mini">
              <p className="username-mini fs-16 fw-700 margin-0">User Name</p>
              <p className="user-role-mini fs-12">IT Specialist</p>
            </div>
            <div className="profile-text-mini mt-3 align-items-start pl-2">
            ...
            <div className="profile-text-mini2  align-items-start pl-2">
              <p className="user-role-mini fs-12 fw-800 d-flex align-items-center mt-1">
        ...
        <div className="mt-5 secondary-side-nav">
        ...
        <div className="profile-text-mini2  align-items-center">
