    ...
    <Modal {...props} className="post-model">
      ...
      <Modal.Body>
        <div className="d-flex">
          {" "}
          <div>
            <img className="xs-profiles" src={myProfile.image} alt="" />
          </div>
        ...
        >
          <Form.Group controlId="exampleForm.ControlInput1">
            <Form.Control value="" name="postText" as="textarea" rows={3} placeholder="What do you want to talk about?" className="post-text" />
          </Form.Group>
        </Form>
